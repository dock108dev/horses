...
Shared fixtures and stub adapters live in ``api/tests/conftest.py``;
helpers used by name (``_full_card``, ``_seed_cache``,
``_client_with_overrides``, etc.) are imported below.
"""
